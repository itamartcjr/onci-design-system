...
const specs: Record<SystemPageKey, Spec> = {
  ...
  'foundation-typography': {
    ...
    purpose: 'Manter leitura eficiente sem perder caráter. A fonte de marca não substitui a fonte de interface: elas têm papéis complementares.', kind: 'typography', variants: ['1797 · Medium', '1797 · Italic', '1797 · Poster', 'Nunito Sans', 'Escala fluida'], tech: [
